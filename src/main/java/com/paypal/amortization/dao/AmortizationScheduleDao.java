 ...
 * 
 */
package com.paypal.amortization.dao;
...
public class AmortizationScheduleDao implements Serializable {
	...
	public String toString() {
		return "AmortizationScheduleDO [paymentNumber=" + paymentNumber + ", monthlyPaymentAmount="
				+ monthlyPaymentAmount + ", currentMonthlyInterest=" + currentMonthlyInterest + ", currentBalance="
				+ currentBalance + ", totalAmountPaid=" + totalAmountPaid + ", totalInterestPaid=" + totalInterestPaid
				+ "]";
	}	
